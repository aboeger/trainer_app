class EventRemindersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_reminder.save
        ...
        format.json { render :show, status: :created, location: @event_reminder }
      else
  ...
  def update
    respond_to do |format|
      if @event_reminder.update(event_reminder_params)
        ...
        format.json { render :show, status: :ok, location: @event_reminder }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to event_reminders_url, notice: 'Event reminder was successfully destroyed.' }
  ...
  private
    ...
    def event_reminder_params
      params.require(:event_reminder).permit(:title, :start, :end, :notes)
    end
end
