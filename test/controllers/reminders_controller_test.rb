...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { name: @reminder.name, notes: @reminder.notes, reminder_date: @reminder.reminder_date }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { name: @reminder.name, notes: @reminder.notes, reminder_date: @reminder.reminder_date }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
